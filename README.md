...
Real-time telemetry dashboard for the [VectorVario](https://vectorvario.com) paragliding sensor. Connects via Web Bluetooth to display true airspeed (TAS), temperature, humidity, and battery status with live-updating graphs.
